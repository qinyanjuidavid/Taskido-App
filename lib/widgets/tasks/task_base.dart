...
class Taskbase extends StatefulWidget {
  final List<TaskResult> taskValue;
  Taskbase({Key? key, required this.taskValue}) : super(key: key);

  @override
  State<Taskbase> createState() => _TaskbaseState();
}

class _TaskbaseState extends State<Taskbase> {
        ...
        builder: (context, value, child) {
          ...
          return ListView.builder(
            itemBuilder: (context, index) {
              var task = value.completedTasks[index];
              ...
              return TaskContainer(
                onTap: () async {
                  ...
                  taskUpdateTextEditingController.text = task.task.toString();
                  noteUpdateTextEditingController.text = task.note.toString();
                  categoryTextEditingController.text = task.category.toString();
